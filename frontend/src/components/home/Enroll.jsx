...
function Enroll() {
  ...
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        const response = await axios.get(`https://stealthmode-server.vercel.app/api/courses/${id}`);
  ...
  try {
    const response = await axios.post('https://stealthmode-server.vercel.app/api/courses/enroll', {
      userId: user._id,
      courseId: course._id,
    });
